...
"""
  ...
  Test suite for the ROS2 minimal publisher.

  This script contains unit tests for verifying the dunctionallity of a minimal ROS2  publisher
  ...
  Publishing Topics:
    /py_example_topic (std_msg/String): Example messages with incremanting counter
...
def test_publisher_creation():
  ...
  try:
    # Create ana instance of our publisher node
